...
export default function ScrollWrapper() {
  ...
  return (
    <div 
      ...
      className="relative w-full h-screen overflow-hidden bg-white md:bg-neutral-50"
    >
      {/* Sticky Splitscreen Layout */}
      <div className="w-full h-full flex flex-col md:flex-row">
        {/* Left Side: Fading Information Cards */}
        <div className="w-full md:w-1/3 h-[40vh] md:h-full flex flex-col md:justify-center justify-start pt-10 md:pt-0 px-8 md:px-12 bg-white md:bg-gradient-to-r md:from-neutral-50 md:via-neutral-50/90 md:to-transparent z-20 pointer-events-none select-none">
            ...
            <div className="inline-flex items-center space-x-2 bg-red-50 border border-red-200/60 px-3 py-1 rounded-full text-red-600 text-[10px] uppercase font-black tracking-widest stage-badge-reveal">
             ...
             {(() => {
                ...
                return (
                  <div 
                    key={displayedStage} 
                    className={`md:min-h-[160px] min-h-[130px] ${
                      isFadingOut ? 'stage-text-exit' : ''
                    }`}
                  >
                    <h1 className="text-2xl md:text-3xl font-black text-neutral-900 leading-tight uppercase font-sans tracking-wide flex flex-wrap">
        ...
        <div className="flex-1 h-[60vh] md:h-full relative bg-white md:bg-neutral-50">
          {/* Premium light studio vignette backdrop gradient */}
          <div className="absolute inset-0 bg-white md:bg-[radial-gradient(circle_at_center,_#ffffff_0%,_#fafafa_60%,_#f3f3f3_100%)] pointer-events-none z-0" />
