    ...
    <div className="w-full min-h-screen bg-neutral-50 flex items-center justify-center p-6">
      <div className="w-full max-w-md bg-white border border-neutral-200/80 p-8 rounded-3xl shadow-xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-neutral-500 text-xs font-light">Введите учетные данные менеджера для обработки заявок</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input 
                ...
                placeholder="manager" 
                className="w-full bg-white border border-neutral-200 rounded-xl pl-10 pr-4 py-3 text-xs text-neutral-900 placeholder-neutral-400 focus:outline-none focus:border-red-600 focus:ring-1 focus:ring-red-500/10"
              />
            </div>
          </div>
          ...
          <button 
            type="submit"
            disabled={loading}
            className="w-full bg-red-600 hover:bg-red-700 disabled:bg-neutral-350 text-white font-bold py-3.5 rounded-xl text-xs uppercase tracking-wider transition-all hover:shadow-lg shadow-sm cursor-pointer mt-2"
          >
